        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-qforma-blue">
                Complete QA Management Platform for Testing Teams
              </h1>
              <p className="text-lg mb-8 text-muted-foreground">
                From requirements to test cases, defect tracking to reporting — QForma streamlines your entire QA workflow with powerful AI assistance.
              </p>
